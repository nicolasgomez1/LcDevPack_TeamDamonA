...
namespace LcDevPack_TeamDamonA
{
    ...
    {
        private readonly string Host = ExportLodHandle.connection.ReadSettings("Host");
        ...
        public void ExportItemAll_V4()
        {
            ...
            string str1 = "SELECT * FROM t_item WHERE a_zone_flag=1023 AND a_enable = 1 ORDER by a_index";
