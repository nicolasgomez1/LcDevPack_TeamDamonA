...
namespace LcDevPack_TeamDamonA
{
    public class Main : Form
    {
        ...
        private readonly string Host = Main.connection.ReadSettings("Host");
        private readonly string User = Main.connection.ReadSettings("User");
        private readonly string Password = Main.connection.ReadSettings("Password");
        private readonly string Database = Main.connection.ReadSettings("Database");
        private readonly string Episode = Main.connection.ReadSettings("Episode");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            checkedListBox1.Items.AddRange(new object[23]
      {
         "Catalog",
         "LuckyDraw",
         "Magic",
     ...
     //   "LcBall",
        ...
        private void checkedListBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            foreach (string checkedItem in checkedListBox1.CheckedItems)
            {
                ...
                if (checkedItem == "DailyLogin")
                    new DailyLogin2().Show();
                if (checkedItem == "StartItem")
                    new Startitem().Show();
